...
function install_dockerdomain_resolver() {
...
function install_docker_nginx_proxy() {
...
function _install_nginx_proxy() {
  install_dockerdomain_resolver
  install_docker_nginx_proxy
}

_install_nginx_proxy
